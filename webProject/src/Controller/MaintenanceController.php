...
class MaintenanceController extends AbstractController
{
    ...
    #[Route('/{idDemande}', name: 'app_maintenance_show', methods: ['GET'])]
    ...
    #[Route('/{idDemande}/edit', name: 'app_maintenance_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idDemande}', name: 'app_maintenance_delete', methods: ['POST'])]
    public function delete(Request $request, Maintenance $maintenance, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$maintenance->getIdDemande(), $request->request->get('_token'))) {
