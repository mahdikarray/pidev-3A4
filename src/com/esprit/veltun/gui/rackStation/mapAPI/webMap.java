package com.esprit.veltun.gui.rackStation.mapAPI;
...
public class webMap extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        final WebEngine webEngine = new WebEngine(
                getClass().getResource("/mapAPI/map.html").toString());
        ...
        searchBox.prefColumnCountProperty();
        ...
        scene.getStylesheets().add("/mapAPI/webMap.css");
        // show stage
        stage.show();
    }
