package com.esprit.veltun.gui.event.jfxcalendar.controllers;
...
public class EventDetailPaneController {
	...
	private void update(CalendarEvent event) {
		Event event1 = eventService.findById(event.getId());
		event1.setTitre(event.getTitle());
		event1.setDescription(event.getDescription());
		event1.setDateDebut(Date.valueOf(event.getDate()));
		event1.setDateFin(Date.valueOf(event.getDate()));
