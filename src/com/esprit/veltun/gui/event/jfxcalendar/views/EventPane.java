...
import com.esprit.veltun.gui.event.jfxcalendar.controllers.EventDetailPaneController;
import com.esprit.veltun.gui.event.jfxcalendar.dialog.DialogHandler;
	...
	public EventPane(CalendarEvent event) {
		...
		completedCheckButton.setOnAction(e -> {
			...
			if (calendarDayView != null) {
              ...
              /* <ImageView fitHeight="126.0" fitWidth="234.0" layoutX="-25.0" layoutY="316.0">
                  <image>
                     <Image url="https://openweathermap.org/img/wn/09d@2x.png" />
                  </image>
               </ImageView>*/
