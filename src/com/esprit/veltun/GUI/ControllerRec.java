...
public class ControllerRec implements Initializable {
   ...
   /* @FXML
    ...
    @FXML
    private Label label_id_reclamation,label_objet,label_description,label_etat,label_date_reclamation;
    @FXML
    ...
    @FXML
    private DatePicker fxdate_reclamation;

    @FXML
    private Button fxajouterRec;
    @FXML
    private Button fxModifRec;
    @FXML
    private Button fxDeleteRec;
    @FXML
    private Button fxafficheRec;
    @FXML
    private Button fxRecherchRec;
    ...
    @FXML
    public ListView<Reclamation> list;
...
fxTypeab.setItems(TypeabList);
    ...
    private void addRec(ActionEvent event) {
       /* String objet= fxobjet.getText();
        ...
        String objet = String.valueOf(fxobjet.getText());
        String description = String.valueOf(fxdescription.getText());
        String etat = String.valueOf(fxetat.getText());
        Date date_reclamation = Date.valueOf(fxdate_reclamation.getValue());

        Reclamation p = new Reclamation(id_reclamation,objet,description,etat,date_reclamation);
        ReclamationServiceImpl pc = new ReclamationServiceImpl();
        pc.save(p);
        FXMLLoader loader = new FXMLLoader(getClass().getResource("reclamation.fxml"));
        try {
            Parent root = loader.load();
            ControllerRec dc = loader.getController();
            dc.setFxid_reclamation(p.getId_reclamation());
            dc.setFxobjet(p.getObjet());
            dc.setFxdescription(p.getDescription());
            dc.setFxetat(p.getEtat());
            dc.setFxdate_reclamation(p.getDate_reclamation());
   ...
   // void setFxCIN(String cin) {
    ...
    @FXML
    private void RechRec(ActionEvent event) {
       ...
       // String Type_ab = String.valueOf(fxTypeab.getText());
        ...
        try {
            ...
            while(RS.next()) {
                ReclamationSearchCriteria searchCriteria = new ReclamationSearchCriteria();
    ...
    public void setFxdate_reclamation(Date date_reclamation) {
    }
